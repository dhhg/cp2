...
class ModelosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'modelos_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'activo' => 1,
            'created' => '2017-08-10 18:12:29',
            'modified' => '2017-08-10 18:12:29',
            'user_id' => 1
        ],
    ];
}
