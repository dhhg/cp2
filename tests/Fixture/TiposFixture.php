...
class TiposFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'tipos_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'activo' => 1,
            'created' => '2017-08-06 18:23:48',
            'modified' => '2017-08-06 18:23:48',
            'user_id' => 1
        ],
    ];
}
